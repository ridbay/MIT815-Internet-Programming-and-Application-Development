    ...
    <div className="dashboard">
      ...
      >
        <h1 style={{ fontSize: "2.5rem", marginBottom: "1rem" }}>
          Welcome to the{" "}
          <span className="premium-gradient-text">MIT815 Portal</span>
        </h1>
        <p style={{ color: "var(--text-muted)", fontSize: "1.1rem" }}>
          Advanced Engineering & Specialized Systems. Master the core principles
          and excel in your final assessments.
        </p>
      </motion.div>
      ...
      >
        <ModuleLink
          title="Study Guide"
          desc="Structured summaries and network protocol overviews."
          icon={<BookOpen size={24} />}
          onClick={() => onNavigate("summaries")}
        />
        <ModuleLink
          title="Flashcards"
          desc="Test your memory with active recall cards."
          icon={<Zap size={24} />}
          onClick={() => onNavigate("flashcards")}
        />
        <ModuleLink
          title="Quiz Arena"
          desc="Practice with a vast bank of networking MCQs."
          icon={<Target size={24} />}
